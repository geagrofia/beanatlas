...
``` {r, results = 'asis', echo = T, cache=TRUE, fig.height = 4, fig.width = 7}
...
```{r bean_atlas_1, cache=TRUE, fig.height = 4, fig.width = 7, fig.cap = "Sourcing Area Boundaries", dev = 'png'}
...
```{r bean_atlas_1_join, cache=TRUE, fig.height = 4, fig.width = 7, fig.cap = "Sourcing Area Boundaries", dev = 'png'}
...
```{r bean_atlas_1_join_map, cache=TRUE, fig.height = 4, fig.width = 7, fig.cap = "Sourcing Area Boundaries", dev = 'png'}
...
myAfricaMap +
  geom_sf(
    data = v_bean_atlas_poly_1_main_var,
    aes(fill = VAR),
    col = "red",
    alpha = 1,
    inherit.aes = FALSE
...
```{r bean_atlas_2, cache=TRUE, fig.height = 4, fig.width = 7, fig.cap = "Sourcing Area Boundaries", dev = 'png'}
...
myAfricaMap +
  ...
  geom_sf_text(
    ...
    stat = "sf_coordinates",
    position = "identity",
    aes(geometry = geometry, label = paste(MBPA_NAME)),
    size = 2,
    inherit.aes = FALSE
  )
...
```{r sole_compare, cache=TRUE, fig.height = 10, fig.width = 7, fig.cap = "Sourcing Area Boundaries", dev = 'png'}
...
```{r maize_compare, cache=TRUE, fig.height = 10, fig.width = 7, fig.cap = "Sourcing Area Boundaries", dev = 'png'}
...
```{r CB_compare, cache=TRUE, fig.height = 15, fig.width = 7, fig.cap = "Sourcing Area Boundaries", dev = 'png'}
